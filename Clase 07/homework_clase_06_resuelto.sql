...
-- WHERE ca.nombre LIKE '%Stack Developer%'; -- OK
-- WHERE ca.nombre NOT LIKE '%Science%'; -- NOT OK
WHERE ca.idCarrera = 1;

SELECT idCarrera, idCarrera * 1.21 AS idCarrera_con_iva, nombre 
FROM carrera
WHERE idCarrera * 1.21 > 2;